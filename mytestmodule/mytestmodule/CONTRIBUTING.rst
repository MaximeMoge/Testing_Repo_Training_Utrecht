...
1. use the search functionality `here <https://github.com/MaximeMoge/mytestmodule/issues>`_ to see if someone already filed the same issue;
...
1. `push <http://rogerdudler.github.io/git-guide/>`_ your feature branch to (your fork of) the MyTestModule repository on GitHub;
